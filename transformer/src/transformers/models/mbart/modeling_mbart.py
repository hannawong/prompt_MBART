...
class MBartEncoder(MBartPreTrainedModel):
    ...
    def __init__(self, config: MBartConfig, embed_tokens: Optional[nn.Embedding] = None,encoder_prompt_len = 0,args = None):
    ...
    def forward(
        ...
        hidden_states = torch.cat((prompt_embeds,hidden_states[:,self.encoder_prompt_len:,:]),dim = 1)
...
class MBartModel(MBartPreTrainedModel):
    ...
    def __init__(self, config: MBartConfig, encoder_prompt_len = 0,args = None):
        super().__init__(config)

        padding_idx, vocab_size = config.pad_token_id, config.vocab_size
        self.shared = nn.Embedding(vocab_size, config.d_model, padding_idx)
        self.encoder = MBartEncoder(config, self.shared, encoder_prompt_len=encoder_prompt_len,args = args)
...
class MBartForConditionalGeneration(MBartPreTrainedModel):
    ...
    def __init__(self, config: MBartConfig, encoder_prompt_len = 0,args= None):
        super().__init__(config)
        self.model = MBartModel(config, encoder_prompt_len = encoder_prompt_len,args= args)
